...
public class ladyfinger extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate your ladyfinger layout XML file here
        return inflater.inflate(R.layout.fragment_ladyfinger, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addToCartBtn.setOnClickListener(v -> {
            if (quantity > 0) {
                Toast.makeText(getContext(), quantity + " Ladyfinger(s) added to cart", Toast.LENGTH_SHORT).show();
                // Add your add-to-cart logic here
            } else {
                Toast.makeText(getContext(), "Please select at least 1 ladyfinger", Toast.LENGTH_SHORT).show();
            }
        });
