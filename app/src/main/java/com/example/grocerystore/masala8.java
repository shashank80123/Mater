...
public class masala8 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Make sure your layout file name is fragment_masala8.xml or update this accordingly
        return inflater.inflate(R.layout.fragment_masala8, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addToCartBtn.setOnClickListener(v -> {
            if (quantity > 0) {
                Toast.makeText(getContext(), quantity + " Chat masala(s) added to cart", Toast.LENGTH_SHORT).show();
            } else {
