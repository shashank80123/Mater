...
public class masala9 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Replace with your actual layout file name if different
        return inflater.inflate(R.layout.fragment_masala9, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addToCartBtn.setOnClickListener(v -> {
            if (quantity > 0) {
                Toast.makeText(getContext(), quantity + " Garam masala(s) added to cart", Toast.LENGTH_SHORT).show();
            } else {
