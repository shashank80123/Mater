...
public class masala2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Make sure the layout name matches the actual XML file name (e.g., fragment_masala2.xml)
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        updateQuantity(); // Set initial quantity
        ...
        addToCartBtn.setOnClickListener(v -> {
            if (quantity > 0) {
                Toast.makeText(getContext(), quantity + " Khada masala(s) added to cart", Toast.LENGTH_SHORT).show();
