...
public class cake3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the cake3 layout (assuming filename is fragment_cake3.xml)
        return inflater.inflate(R.layout.fragment_cake3, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addToCartBtn.setOnClickListener(v -> {
            if (quantity > 0) {
                Toast.makeText(getContext(), quantity + " chokletcake(s) added to cart", Toast.LENGTH_SHORT).show();
                // TODO: Add logic for cart addition here
            } else {
                Toast.makeText(getContext(), "Please select at least 1 chokletcake", Toast.LENGTH_SHORT).show();
            }
        });
