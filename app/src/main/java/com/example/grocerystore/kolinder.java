...
public class kolinder extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate your kolinder layout XML file here
        return inflater.inflate(R.layout.fragment_kolinder, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addToCartBtn.setOnClickListener(v -> {
            if (quantity > 0) {
                Toast.makeText(getContext(), quantity + " Coriander(s) added to cart", Toast.LENGTH_SHORT).show();
                // TODO: Implement actual add to cart logic here
            } else {
                Toast.makeText(getContext(), "Please select at least 1 coriander", Toast.LENGTH_SHORT).show();
            }
        });
