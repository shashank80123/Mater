...
public class ginger extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addToCartBtn.setOnClickListener(v -> {
            if (quantity > 0) {
                Toast.makeText(getContext(), quantity + " Ginger(s) added to cart", Toast.LENGTH_SHORT).show();
                // Add your add-to-cart logic here
            } else {
                Toast.makeText(getContext(), "Please select at least 1 ginger", Toast.LENGTH_SHORT).show();
            }
        });
