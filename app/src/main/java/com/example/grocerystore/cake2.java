...
public class cake2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate your new cake2 layout
        return inflater.inflate(R.layout.fragment_cake2, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addToCartBtn.setOnClickListener(v -> {
            if (quantity > 0) {
                Toast.makeText(getContext(), quantity + " Cake(s) added to cart", Toast.LENGTH_SHORT).show();
                // TODO: Handle adding to cart logic here
            } else {
                Toast.makeText(getContext(), "Please select at least 1 cake", Toast.LENGTH_SHORT).show();
            }
        });
